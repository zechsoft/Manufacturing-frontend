...
const SalesDashboard = () => {
  ...
  const stats = [
    { label: 'Total Sales Orders', value: '342', icon: DollarSign, color: 'blue' },
    { label: 'Active Customers', value: '187', icon: Users, color: 'green' },
    { label: 'Pending Quotations', value: '28', icon: FileText, color: 'yellow' },
    { label: 'Monthly Revenue', value: '₹67.8L', icon: TrendingUp, color: 'purple' },
  ];

  const recentOrders = [
    { id: 'SO-2024-001', customer: 'Tech Industries', amount: '₹3,45,000', status: 'Confirmed', date: '2024-12-10' },
    { id: 'SO-2024-002', customer: 'Manufacturing Co', amount: '₹1,85,000', status: 'Pending', date: '2024-12-09' },
    { id: 'SO-2024-003', customer: 'Auto Parts Ltd', amount: '₹4,25,000', status: 'Processing', date: '2024-12-08' },
    { id: 'SO-2024-004', customer: 'Steel Solutions', amount: '₹2,95,500', status: 'Shipped', date: '2024-12-07' },
  ];
    ...
    <div className="flex min-h-screen bg-gray-100 relative">
      ...
      <div className="w-64 bg-gray-800 text-white min-h-screen fixed left-0 top-0 z-10">
        <div className="p-4 border-b border-gray-700">
          ...
          <p className="text-gray-400 text-sm">Sales Portal</p>
        </div>
      ...
      <div className="flex-1 ml-64 p-6 relative z-5">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">Manage sales operations and customer relationships</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <div className="flex items-center gap-4">
            <div className="relative flex-1">
              ...
              <input
                type="text"
                placeholder="Search customers, products, or SO numbers..."
                value={searchTerm}
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-bold text-gray-900 mb-4">Recent Sales Orders</h2>
